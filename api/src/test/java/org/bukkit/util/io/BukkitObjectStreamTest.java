...
import java.util.Base64; // Margit
...
// import org.yaml.snakeyaml.external.biz.base64Coder.Base64Coder; // Margit
...
public class BukkitObjectStreamTest {
    ...
    public void checkSerlialization() throws Throwable {
        ...
        final byte[] preEncodedArray = Base64.getDecoder().decode(preEncoded); // Margit
