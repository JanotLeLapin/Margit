...
public final class PluginDescriptionFile {
    private static final ThreadLocal<Yaml> YAML = new ThreadLocal<Yaml>() {
        ...
        protected Yaml initialValue() {
            ...
            // KigPaper end
            return new Yaml(new SafeConstructor(new LoaderOptions()) { // Margit
                {
            ...
            }, new Representer(new DumperOptions()), new DumperOptions(), loadingConfig); // KigPaper - CVE-2017-18640 // Margit
        }
    };
    String rawName = null;
