...
public interface Player extends HumanEntity, Conversable, CommandSender, OfflinePlayer, PluginMessageRecipient {
    ...
    /**
     * Sets the invulnerability flag in the player's capabilities.
     * Being invulnerable also makes insentient entities ignore you.
     * @param invulnerable whether the player should be immune to attacks
     */
    void setInvulnerable(boolean invulnerable);

    /**
     * Returns the invulnerability flag from the player's capabilities.
     * Being invulnerable also makes insentient entities ignore you.
     */
